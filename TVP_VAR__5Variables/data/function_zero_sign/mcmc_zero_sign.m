...
%               
                for t = 1:ns
                    if sign_chk(t)==1  
                       ...
                       mA0_t(t,:) =    mA0_t(t,:) + A0_t(t,:);
                       mA0s_t(t,:) =  mA0s_t(t,:) + A0_t(t,:).^2;
                       n_IRF(t)=n_IRF(t)+1;
                    end
                end                
...
save(['./output/tvpvar_a0_' num2str(jj) '.xls'], 'mA0_t',  '-ascii', '-tabs');
save(['./output/tvpvar_a0s_' num2str(jj) '.xls'], 'mA0s_t',  '-ascii', '-tabs');
